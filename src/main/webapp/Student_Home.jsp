<%-- 
    ...
    Created on : 17 November, 2023, 2:31:31 PM
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id='bs-example-navbar-collapse-1'>
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="student_attendance.jsp">Attendance</a></li>
        ...
        <section id="about">
            <div class="container">
                <div class="row">
                        ...
                        %>
                    <div class="col-md-12">
                        <h2 class="wow bounceIn" data-wow-offset="50">Welcome <%=name.toUpperCase()%>!</h2>
                    </div>
