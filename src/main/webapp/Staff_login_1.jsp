<%-- 
    Document   : staff login1
    Created on : 17 November, 2023, 1:31:31 PM
    ...
    <body id="top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id='bs-example-navbar-collapse-1'>
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="active"><a href="Staff_login.jsp">Staff</a></li>
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <section id="contact">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="wow bounceIn" data-wow-offset="50" data-wow-delay="0.3s">Staff <span>Login</span></h2>
                    </div>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 wow fadeInRight" data-wow-offset="50" data-wow-delay="0.6s">
                        <img src="images/ulogin.jpg" width="500" height="300" />
                    </div>
                </div>
            </div>
        </section>
