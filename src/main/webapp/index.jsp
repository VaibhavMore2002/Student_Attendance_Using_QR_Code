<%-- 
    Document   : index
    Created on : 16 November, 2023, 12:31:31 PM
    ...
    <body id="top">
        ...
        <section id="home">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="wow fadeIn" data-wow-offset="50" data-wow-delay="0.9s" style="color:#ffffff">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <a href="https://github.com/VaibhavMore2002" id="github-link" target="_blank">
                            <i class="fab fa-github" id="github-icon"></i>
                           Vaibhav More (MC-I-132)
                        </a>
                        </p>
                        <br>
                        <p class="wow bounceIn" data-wow-delay="0.3s">
