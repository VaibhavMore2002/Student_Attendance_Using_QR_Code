<%-- 
    ...
    Created on : 17 November, 2023, 4:31:31 PM
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 wow fadeInLeft" data-wow-offset="50" data-wow-delay="0.9s">
                        <form action="student_signin.jsp" method="post">
                            <label>EMAIL</label>
                            ...
                            <a href="student_signup.jsp" class="btn btn-primary btn-lg">Register!</a>
                        </form>
                    </div>
                    <div class="col-md-6 col-sm-6 col-xs-12 wow fadeInRight" data-wow-offset="50" data-wow-delay="0.6s">
                        <img src="images/login.jpg" width="480" height="350" />
                    </div>
                </div>
            </div>
        </section>
